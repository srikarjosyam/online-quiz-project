<?php
 ...
 $res= mysql_query("SELECT name,pass,email FROM teacher WHERE email=".$_SESSION['user']);
 if ($res) {
    $userRow=mysql_fetch_array(mysql_query("SELECT name,pass,email FROM teacher WHERE email=".$_SESSION['user']));
}
				...
				<div class="row">
					...
					<div id="content" class="8u skel-cell-important">
						<section>
							...
							<p>here you can create quizzes for the following subjects listed at the left side.Each quiz has 10 questions.you need to prepare 10 questions and give four options and also give the correct option and submit the questions</p>
								</section>
					</div>
